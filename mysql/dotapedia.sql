...
--
-- Host: db
-- Generation Time: Jul 09, 2022 at 04:31 PM
...
--
ALTER TABLE `game`
  MODIFY `game_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=144;
...
--
ALTER TABLE `player_game`
  MODIFY `player_game_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1471;
...
--
ALTER TABLE `series`
  MODIFY `series_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=105;
...
--
ALTER TABLE `tournament_roundrobin`
  MODIFY `tournament_roundrobin_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=77;

--
-- AUTO_INCREMENT for table `tournament_team`
--
ALTER TABLE `tournament_team`
  MODIFY `tournament_team_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;
