...
--
-- Host: db
-- Generation Time: Jan 06, 2022 at 09:46 AM
...
--
ALTER TABLE `game`
  MODIFY `game_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=42;
...
--
ALTER TABLE `player_game`
  MODIFY `player_game_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=461;
...
--
ALTER TABLE `series`
  MODIFY `series_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
...
--
ALTER TABLE `tournament_bracket`
  MODIFY `tournament_bracket_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
