...
--
-- Host: db
-- Generation Time: Jan 07, 2022 at 04:33 AM
...
(72, 'outworld devourer', 'INTELLIGENCE', 1),
(73, 'pangolier', 'AGILITY', 1),
(74, 'phantom assassin', 'AGILITY', 1),
(75, 'phantom lancer', 'AGILITY', 1),
...
--
ALTER TABLE `game`
  MODIFY `game_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=63;
...
--
ALTER TABLE `player_game`
  MODIFY `player_game_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=711;
...
--
ALTER TABLE `series`
  MODIFY `series_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;
